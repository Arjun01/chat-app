...
io.on('connection', (socket)=>{
    ...
    socket.on('sendMessage',(message, callback)=>{
        ...
        socket.broadcast.to(user.room).emit('senderMessage',generateMessage(user.username,message));
        callback();
    })
    ...
    socket.on('sendLocation', (coords, callback)=>{
        ...
        socket.broadcast.to(user.room).emit('senderLocationMessage', generateLocationMessage(user.username,`https://google.com/maps?q=${coords.latitude},${coords.longitude}`));
        callback();
    })
